...
</style></head><body><main><div style="color:var(--teal);font-weight:700;letter-spacing:.08em">YOYO TRADING · V10 PRELABELS</div><h1>ETH 3m · v10预标200张</h1><p class="sub">本页只包含 v10 真正检出并画框的图片。200 张按顺序全部展开，直接向下滑动查看。</p><div class="warn"><b>看图口径：</b>单张白底图；竖虚线左侧是 v10 的200根因果输入，右侧固定增加未来3小时。保留K线与均线，不画入场、止盈、止损、成交量或背景填充。</div><div class="kpis"><div class="kpi"><b>200</b><span>全部有v10框</span></div><div class="kpi"><b>0.30</b><span>v10置信度门槛</span></div><div class="kpi"><b>3h</b><span>人工未来窗</span></div></div><section>{''.join(cards)}</section></main></body></html>'''
