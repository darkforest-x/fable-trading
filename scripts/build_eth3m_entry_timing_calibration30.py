...
</style></head><body><main><div class="eyebrow">FABLE TRADING · ETH 3M SHORT</div><h1>提前入场线校准 · 30张</h1><p class="sub">这 30 张都来自你已经判断“形态是”的独立事件。页面没有按钮，直接往下滑；这里只校准橙色入场判断线，不重新判断形态。</p><div class="rule"><b>唯一问题：</b>橙色竖线左侧是模型当时能看到的 200 根，右侧是人工可看的未来 3 小时。如果在橙线处准备做空，这个时机来得及吗？</div><div class="stats"><div class="stat"><b>30</b>独立事件</div><div class="stat"><b>{summary['lead_minutes_median']:.0f}min</b>比原v10中位提前</div><div class="stat"><b>3h</b>固定人工未来窗</div></div>{''.join(cards)}</main></body></html>'''
