...
export FABLE_T3_EXPERIMENT_ID="exp-5m-ma-launch-outcome-x8-train960-v1"
export FABLE_T3_PREREG="experiments/active/${FABLE_T3_EXPERIMENT_ID}/preregistration.json"
export FABLE_T3_DATASET="datasets/ma_launch_5m_outcome_x8_v1"
...
export FABLE_T3_RUN_NAME="ma_launch_5m_outcome_x8_v1_y11s_ft960"
export FABLE_T3_IMGSZ="960"
export FABLE_T3_EPOCHS="40"
export FABLE_T3_PATIENCE="0"
export FABLE_T3_BATCH="8"
export FABLE_T3_REMOTE_DATASET_NAME="ma_launch_5m_outcome_x8_v1_input"
export FABLE_T3_LOCAL_OUTPUT_ROOT="analysis/output/ma_launch_5m_outcome_x8_v1"
export FABLE_T3_DATASET_IMAGE_COUNT="29619"
