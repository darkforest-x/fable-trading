"""Saved-only V22 descriptives using the statistical-analysis skill utility.
...
E = ROOT / 'experiments/active/exp-btcusdtp-1h-external-change-preholdout-20260907-v22'
