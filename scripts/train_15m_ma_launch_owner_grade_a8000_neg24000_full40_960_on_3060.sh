#!/bin/bash
# Train the frozen Owner Grade-A dataset at imgsz=960 for all 40 epochs.
set -euo pipefail

cd "$(dirname "$0")/.."

export FABLE_T3_EXPERIMENT_ID="exp-15m-ma-launch-owner-grade-a8000-neg24000-train960-full40-v1"
...
export FABLE_T3_RUN_NAME="ma_launch_owner_grade_a8000_neg24000_v1_y11s_ft960_full40"
export FABLE_T3_IMGSZ="960"
export FABLE_T3_EPOCHS="40"
export FABLE_T3_PATIENCE="0"
export FABLE_T3_BATCH="8"
export FABLE_T3_REMOTE_DATASET_NAME="ma_launch_owner_grade_a8000_neg24000_v1_full40_960_input"
