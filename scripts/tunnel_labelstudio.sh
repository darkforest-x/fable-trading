...
#   export VPS_HOST=user@your.vps.ip   # default root@206.237.14.112
...
VPS_HOST="${VPS_HOST:-root@206.237.14.112}"
VPS_PORT="${VPS_PORT:-18081}"
LOCAL_PORT="${LOCAL_PORT:-8081}"
ONLY_PRIMARY="${ONLY_PRIMARY:-0}"

if [[ -z "$VPS_HOST" ]]; then
  echo "Set VPS_HOST, e.g. export VPS_HOST=root@206.237.14.112" >&2
  exit 1
fi
