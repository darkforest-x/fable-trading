...
**阶段 2b 正式验收通过（2026-07-08）**：expanded × v2 在 holdout 一次性评估中
AUC 0.602（p=0.001）、top-decile 扣成本净收益 +0.083%，两项标准全部满足
（owner 批准后执行，该配置 holdout 已消耗，不得再碰）。
当前工作 = 阶段 3：带成本的事件驱动回测。
