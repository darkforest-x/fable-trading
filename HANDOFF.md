...
- 报告`analysis/p1_spike_v128_entry_clock_20260923.md`，实验`exp-spike-v128-entry-clock-20260923-v1`最终`summary_v2`。12测试通过，240桶独立复算一致；v1仅receipt类型写入失败，修复后3CSV逐字节相同。GPT6 Luna Max只读时间口径复核已验证；无Pine/退出/成本/生产改动，资格false。
