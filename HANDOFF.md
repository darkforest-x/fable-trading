...
16. P2.5 Phase 0+1 已完成（2026-07-10）：ops Bearer/`X-Ops-Token` 鉴权、
    `analysis/output` 实验注册表、议程只读 API + 前端 tab；
    `ENABLE_JOB_EXECUTOR` 默认 0，**尚无任务运行器**。说明见
    `docs/P2_5_PHASE01_README.md`；设计见 `docs/P2_5_OPS_CONSOLE_DESIGN.md`。
