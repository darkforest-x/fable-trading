...
def plot_case(f, line):
    ...
    axes[1].text(.0,1.06, "C: Sep16 19:30 open → known 20:15 close; breakout: Sep17 02:15 bar → confirmed 02:30 close", transform=axes[1].transAxes, va="bottom", fontsize=9, color="#52525b")
    axes[1].set_title("C confirmation and two-close breakout", loc="left", fontsize=12, pad=42)
