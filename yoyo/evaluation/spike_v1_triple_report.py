...
def build():
    ...
    report = [
        ...
        '对“兑现率0.5→0.7”的直接反证据采用冻结原版机会分母，而不是候选规则被早停后缩水的自身MFE。原6253中原版MFE>10R且双方已闭合的167个事件：三规则机会捕获均值/中位数为 **0.233087/0.066336**，锁50%为 **0.408762/0.499465**，保本为 **0.328389/0.405335**。这说明这些规则并未在该高机会桶中以候选自身峰值口径证明“更会兑现大趋势”。',
        '',
        '## 2. 固定前20流动性三年检验',
