...
- **深历史一次性检验 PASS（预注册）**：冻结管道在 2022~2025.5（4 年从未被选型触碰）
  全配置通过——scaled_25_t3 累计净 +30.9%、PF 1.74、1713 笔、无亏损年；策略线迄今最强证据；
- Owner 金标准工程：1268 张 / 684 框（自一致性 0.88）；规则家族天花板 F1 0.45 实锤；
  底座对照 COCO>E2.1 血统>scratch；v3 双底座对照训练中；
- 远程打标隧道上线（VPS:18081 → 本机 Label Studio），owner 需自行修改 LS 密码。
