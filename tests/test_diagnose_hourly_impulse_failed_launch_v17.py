...
SPEC = importlib.util.spec_from_file_location("diagnose_v17", ROOT/"scripts/diagnose_hourly_impulse_failed_launch_v17.py")
...
def checker(values, *, name, plot):
    assert plot is False and name.startswith("V17 ")
