...
description: 在解决非平凡问题（修复 bug、架构决策、反直觉实验结论）之后，把解决思路蒸馏成一条 learnings 笔记写入 docs/learnings/。AGENTS.md 的 learning law 要求每次非平凡解决后自动执行本 skill。
---
...
- 如果洞见修正了 AGENTS.md 的某条规则，同步更新 AGENTS.md
- 笔记之间可以互相引用（相对链接）
