...
本轮增量入口（2026-09-08）：[YOLO本周1043题审核入口修正](html/p1_yolo_review_entry_fix_20260908.html) · [MD源](p1_yolo_review_entry_fix_20260908.md)。同项目3556库存保留；默认按钮实测进入新预框题37277，32+28聚焦测试，无答案写入。

本轮增量入口（2026-09-08）：[IMACD＋YOLO · 确认后全景与后续走势](html/p1_imacd_yolo_followthrough_20260908.html) · [MD源](p1_imacd_yolo_followthrough_20260908.md)。54币1341箭头425确认；24根主观察窗，10幅前100后72全景；279项独立复核通过。后段4H同根平均静态净位移+2.24%，但四组主匹配超额均负且控制抽样敏感，不能称模型带来超额收益；不是组合回测。
