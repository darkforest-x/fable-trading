...
构建提交：`8ff7f752029f3ac2fac8f95276c404b2329bb461`
...
2. 在 2023/2024 四个时间块先选择项目已有的 `slow_slope_12` 方向门，再把 oscillator
   ...
   **+30.22 bp/笔、PF 1.366、
   1% 风险资金收益 +22.82%、15m 收盘最大回撤 20.03%**。
3. 这个正结果仍未过项目的证据门：相对匹配随机对照 +7.64 bp，
   但 UTC 周区块 sign-flip `p=0.2761`，绝对收益周 bootstrap
...
5. V10 的 `vol_ratio_mean8 >= 1` 历史点估计更好（+41.22 bp/笔、
   回撤 13.56%），但它是在 V9 final 已看过之后才选出的，
   且 sign-flip `p=0.4025`；只能作为下一轮纸面 forward 假设。
6. 开发段选择出的 long-only V11 历史点估计为
   +63.39 bp/笔、回撤
   16.73%，但这同样是 consumed-final 后的诊断，
   仅 5/56 笔盈利，
   sign-flip `p=0.4195`。
...
|---|---|---|---|---|
| 2023H1 | 64 | -20.65 | -9.57 | 22.96 |
| 2023H2 | 55 | -1.75 | 16.14 | 21.93 |
| 2024H1 | 78 | 2.57 | -3.31 | 18.61 |
...
|---|---|---|---|---|---|---|---|
| V8_10m | 52 | 27.39 | 不可估 | 不可估 | 不可估 | 21.28 | 14.13 |
| V8_15m | 31 | -39.78 | 11.82 | -51.61 | 0.5251 | -3.31 | 9.39 |
| V9_10m | 29 | -15.99 | 不可估 | 不可估 | 不可估 | 2.12 | 12.80 |
| V9_15m | 25 | -58.68 | 2.79 | -61.47 | 0.4959 | -5.98 | 11.40 |
...
|---|---|---|---|---|---|---|
| V9 | 80 | 108.66 | 22.98 | 85.68 | 0.0492 | 63.84 |
| V10 | 70 | 49.69 | 6.96 | 42.73 | 0.1225 | 1.10 |
| V11 | 42 | 42.95 | -35.85 | 78.79 | 0.2214 | -38.99 |

V9 的 backcast 点估计和匹配超额为正，但 `p=0.0492`，
...
|---|---|---|---|---|---|---|---|
| 2022H1 | 34 | 143.99 | 29.79 | 114.20 | 33.69 | 14.14 | 37.76 |
| 2022H2 | 47 | 73.98 | 18.96 | 55.02 | 9.32 | 13.65 | 1.62 |
| 2023H1 | 42 | 61.02 | 0.64 | 60.38 | 39.80 | 16.68 | 2.01 |
| 2023H2 | 42 | 41.49 | 35.50 | 6.00 | 21.83 | 16.74 | -10.28 |
| 2024H1 | 38 | 199.76 | 45.57 | 154.19 | 60.32 | 9.51 | 137.30 |
| 2024H2 | 45 | 92.04 | -19.18 | 111.21 | 30.52 | 12.22 | 33.75 |
| 2025H1 | 51 | -21.33 | 26.66 | -48.00 | -7.18 | 20.03 | -98.64 |
| 2025H2 | 38 | 155.58 | 120.22 | 35.36 | 40.06 | 12.64 | 88.30 |
| 2026M1M2 | 21 | -61.78 | -31.15 | -30.63 | -4.62 | 11.40 | -100.58 |
...
|---|---|---|---|---|---|
| v9_two_sided | 167 | 41.49 | 96.04 | 4/4 | 16.74 |
| v9_long_only | 81 | 79.40 | 171.15 | 4/4 | 15.76 |
| v9_short_only | 99 | -40.29 | 23.48 | 2/4 | 11.79 |
...
|---|---|---|---|---|---|---|---|
| V8 原 ETH 基线 | discovery_2023 | 181 | 5.14 | -14.86 | 0.963 | -4.48 | 25.99 |
| V8 原 ETH 基线 | confirmation_2024 | 195 | 43.66 | 23.66 | 1.353 | 44.90 | 21.77 |
| V8 原 ETH 基线 | final 2025–2026-02 | 212 | -8.29 | -28.29 | 0.826 | -16.06 | 28.72 |
| V8 + EMA200 slope12 | discovery_2023 | 67 | 97.63 | 77.63 | 2.404 | 81.30 | 23.01 |
| V8 + EMA200 slope12 | confirmation_2024 | 72 | 161.15 | 141.15 | 3.082 | 103.16 | 10.02 |
| V8 + EMA200 slope12 | final 2025–2026-02 | 103 | 18.80 | -1.20 | 1.108 | 5.81 | 27.46 |
| V9 锁定候选 | discovery_2023 | 83 | 72.01 | 52.01 | 1.921 | 70.50 | 26.48 |
| V9 锁定候选 | confirmation_2024 | 83 | 161.35 | 141.35 | 2.748 | 109.26 | 12.22 |
| V9 锁定候选 | final 2025–2026-02 | 110 | 50.22 | 30.22 | 1.366 | 22.82 | 20.03 |
| V10 成交量假设* | discovery_2023 | 62 | 114.72 | 94.72 | 2.984 | 100.75 | 20.52 |
| V10 成交量假设* | confirmation_2024 | 64 | 212.44 | 192.44 | 3.585 | 118.01 | 11.37 |
| V10 成交量假设* | final 2025–2026-02 | 77 | 61.22 | 41.22 | 1.405 | 18.24 | 13.56 |
...
| 匹配随机净收益 | 22.58 bp/笔 | 同月×HK 6h×前一 UTC 月标定 ATR 五分位×方向×持有期 |
| 策略 - 对照 | +7.64 bp/笔 | 正，但不显著 |
| UTC 周 sign-flip | p=0.2761 | **未过 p<0.01** |
...
|---|---|---|---|---|---|
| v9_locked | 30.22 | 32.34 [13.80, 64.80] | -2.11 [-34.58, 16.42] | 43.75 | 0.136–0.568 |
| v10_volume_hypothesis | 41.22 | 33.54 [0.18, 85.13] | 7.68 [-43.91, 41.04] | 59.38 | 0.191–0.737 |
| v11_long_only_postselection | 63.39 | 60.74 [10.12, 103.43] | 2.65 [-40.04, 53.27] | 51.56 | 0.157–0.898 |
...
|---|---|---|---|---|
| 0.50 | 12.14 | 10.61 | 0.29 | 0.57 |
| 0.75 | 17.68 | 15.46 | 0.43 | 0.86 |
| 1.00 | 22.82 | 20.03 | 0.57 | 1.15 |
| 1.25 | 27.51 | 24.34 | 0.72 | 1.44 |
| 1.50 | 31.73 | 28.41 | 0.86 | 1.72 |
| 2.00 | 38.65 | 35.88 | 1.15 | 2.30 |

本轮把 **1%** 作为默认研究风险：0.5% 更稳但收益低；2% 的历史回撤已达 35.88%。
...
|---|---|---|---|---|---|---|---|
| V9 risk 0.50% | 12.14 | 10.61 | 11.47 [-11.40, 43.39] | 18.40 | 22.56 | 2.95 | 22 |
| V9 risk 0.75% | 17.68 | 15.46 | 17.04 [-16.95, 69.70] | 26.37 | 23.16 | 19.25 | 22 |
| V9 risk 1.00% | 22.82 | 20.03 | 21.90 [-22.60, 99.79] | 33.63 | 24.34 | 42.12 | 22 |
| V10 volume 1.00% | 18.24 | 13.56 | 17.62 [-23.09, 89.70] | 32.72 | 27.73 | 38.58 | 27 |
| V11 long-only 1.00% | 17.46 | 16.73 | 15.38 [-19.85, 80.79] | 26.23 | 27.78 | 20.52 | 20 |

![Four-week block bootstrap path risk](../experiments/active/exp-pine-eth-15m-v1/results/charts/path_risk_bootstrap.png)

0.5% 风险把 V9 的实际回撤从
20.03% 压到
10.61%，bootstrap 回撤 95 分位从
33.63% 降到
18.40%；但终值为负的重采样比例仍为
22.56%。因此 **0.5% 是更保守的
...
- **跨制度仍未过门。** V9 虽 7/9 时间块为正，但绝对/匹配精确 p 为 0.0176 / 0.0293；2025H1、2026M1M2 为负。
- **break-even 经济语义错误但本轮未改。** +10 bp 锁盈低于 20 bp 成本，49 笔固定净 -10 bp；任何 offset 修改仍是需 owner 单独批准的新 barrier 实验。
- **随机对照有 assignment 方差。** V9 的 64-seed 超额 5%–95% 为 [-34.58, 16.42] bp；单 seed 不能当确定事实。
...
- **路径 bootstrap 不是预测。** 它只重排已消费时期的 4 周区块；V9 0.5% 风险仍有 22.56% 重采样终值为负，不能解释成未来亏损概率的精确估计。
...
```bash
git checkout e1ab73919e1a6b3797a5c6263f0a73cad25c2a69
