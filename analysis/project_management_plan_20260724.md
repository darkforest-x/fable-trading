...
| S2.4 100×6m 扫池 | ✅ | n=25602；100/100 完成 |
| S2.5 100×6m 回归单切 | ✅ | 净 +0.471% / ρ=0.016 / p=0.037；报告已写 |
| S2.6 100×6m walkforward | ✅ | net_mean +0.305%；ρ_mean −0.010；未达稳健级 |
...
**2026-07-24 裁决**：命中分支 **2（仍间歇 / 排序近随机）**。单切净 +0.471% 但 Spearman 0.016、walkforward ρ_mean 负 → **停止扩币**；默认 S3。

**禁止**：binary 再优化、改 TP/SL/成本、holdout#8、promote。

### Phase S3 — 检测金标加固（🔄 包已出，待 Owner 目视）
